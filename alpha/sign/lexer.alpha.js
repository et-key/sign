...
const _sig_count_indent = Object.assign(((..._args) => {
  ...
  (() => {
  return {"type":"operation","operator":"\\n","left":{"type":"operation","operator":":","left":{"type":"operation","operator":"==","left":{"type":"operation","operator":"'","left":"<line>","right":"0","name":"get_prop"},"right":"\\t","name":"equal"},"right":{"type":"operation","operator":"+","left":"1","right":{"type":"block","kind":"paren","content":{"type":"operation","operator":" ","left":"<count_indent>","right":{"type":"operation","operator":"~","left":"<line>","right":"1","name":"range"},"name":"apply"}},"name":"add"},"name":"define"},"right":"0","name":"newline"};
})()
...
const _sig_process_line = Object.assign(((..._args) => {
  ...
  (() => {
  return {"type":"operation","operator":"\\n","left":{"type":"operation","operator":"\\n","left":{"type":"operation","operator":":","left":{"type":"operation","operator":" ","left":"<is_sol_comment>","right":"<line>","name":"apply"},"right":"<line>","name":"define"},"right":{"type":"operation","operator":":","left":"<count>","right":{"type":"operation","operator":" ","left":"<count_indent>","right":"<line>","name":"apply"},"name":"define"},"name":"newline"},"right":"<line>","name":"newline"};
})()
