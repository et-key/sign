...
- 「Sign Certified」とは、技術サポートを受け、公式Signコンパイラでビルドされたプログラムに付与される認証を指します。
- 「技術サポート」とは、Sign開発チームによって提供される有償のサポートサービスを指します。

## 1. 制作者宣誓
- Sign言語の設計、仕様、公式による実装例の著作権は、その一切を制作者である「岡崎　登」に帰属する
- 公式ツールの設計、及び公式による実装の著作権は、原則として「岡崎　登」に帰属する
...
### 5.2 Sign Certified認証
1. 要件：
   - 直接、間接を問わず軍事利用を目的としていないこと
...
2. 利点：
   - 公式コンパイラ使用の証明
   - 仕様準拠の保証
   - Sign Certifiedマークの使用権
   - 技術サポートサービスの利用

### 5.3 軍事目的の利用に関する不関与
- 軍事目的での利用に対しては直接、間接を問わず、Sign開発チームは一切の技術サポートを行いません
- 軍事目的での利用に対しては直接、間接を問わず、Sign開発チームとの技術サポート契約の締結は出来ません
- 軍事目的での利用に対しては直接、間接を問わず、Sign開発チームは一切関与しません
- 軍事目的での利用に対しては直接、間接を問わず、Sign開発チームはいかなる責任も負いません
- 利用者が本言語を軍事目的に使用する場合、その判断および結果はすべて利用者自身に帰属します
