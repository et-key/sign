...
| 9 | `~*` | infix | range | Around (range vicinity) | Geometric progression specification |
| 9 | `~/` | infix | range | Around (range vicinity) | Descending geometric progression specification |
| 9 | `~^` | infix | range | Around (range vicinity) | Exponential progression specification |
| 10※ | `~` | prefix | continuous | ~trailing | Continuous list construction |
...
| 25 | `\|\|` | infix | bit or | Bit mask | Bitwise logical OR |
| 26 | `;;` | infix | bit xor | Bit mask | Bitwise XOR |
| 27 | `&&` | infix | bit and | Bit mask | Bitwise logical AND |
| 28 | `!!` | prefix | bit not | Bit flip | Bitwise negation |
