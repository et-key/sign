...
export declare const say: SignValue;
export declare const add: <T extends SignValue, U extends SignValue>(x: T | Hole, y: U | Hole) => Atom;
export declare const fold_eager: <T extends SignValue, U extends SignValue, V extends SignValue, W extends SignValue>(f: T | Hole, a: U | Hole, x: V | Hole, ...y: W[]) => SignValue;
export declare const fold_lazy: <T extends SignValue, U extends SignValue, V extends SignValue, W extends SignValue>(f: T | Hole, a: U | Hole, x: V | Hole, ...y: W[]) => SignValue;
export declare const step0: SignValue;
export declare const step1: SignValue;
