(module
  ...
  (elem (i32.const 0) $add $fold_eager $fold_lazy)
  ...
  (func $fold_eager (param $f i64) (param $a i64) (param $x i64) (param $y i64) (result i64)
  (local $tmp_l i64) (local $tmp_r i64)
    local.get $f
    i64.eqz
    (if (then i64.const 0 return))
  ...
  (func $fold_lazy (param $f i64) (param $a i64) (param $x i64) (param $y i64) (result i64)
  (local $tmp_l i64) (local $tmp_r i64)
    local.get $f
    i64.eqz
    (if (then i64.const 0 return))
  ...
  local.set $tmp_l
  local.get $tmp_l
  i64.const 2 ;; func_idx (fold_lazy)
  i64.store offset=8
  local.get $tmp_l
  local.get $f
  i64.store offset=16
