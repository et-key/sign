(module
  ...
  (func $main (export "main") (result f64)
    (local $__cmp_tmp_0 f64)
    (local $__cmp_tmp_1 f64)
    (local $__cmp_tmp_2 f64)
    (local $__cmp_tmp_3 f64)
    f64.const 0 ;; dummy env_ptr
    f64.const 10
    local.tee $__cmp_tmp_0
    f64.const nan
    local.get $__cmp_tmp_0
    f64.const 10
    f64.eq
    select
    call $print
    ...
    f64.const 0 ;; dummy env_ptr
    f64.const 10
    local.tee $__cmp_tmp_1
    f64.const nan
    local.get $__cmp_tmp_1
    f64.const 20
    f64.eq
    select
    call $print
    ...
    f64.const 0 ;; dummy env_ptr
    f64.const 5
    local.tee $__cmp_tmp_2
    f64.const nan
    local.get $__cmp_tmp_2
    f64.const 10
    f64.lt
    select
    call $print
    ...
    f64.const 0 ;; dummy env_ptr
    f64.const 15
    local.tee $__cmp_tmp_3
    f64.const nan
    local.get $__cmp_tmp_3
    f64.const 10
    f64.lt
    select
    call $print
