...
export declare const car: <T extends SignValue, U extends SignValue>(x: T | Hole, ...y: U[]) => Atom;
export declare const cdr: <T extends SignValue, U extends SignValue>(x: T | Hole, ...y: U[]) => Atom;
export declare const res1: SignValue;
export declare const res2: SignValue;
export declare const res3: SignValue;
