...
const car = (() => {
  ...
  _fn.hasRest = true;
  _fn.paramSpecs = [{"name":"x","defaultValue":null,"isRest":false},{"name":"y","defaultValue":null,"isRest":true}];
...
const res1 = _call(cdr, 1, 2, 3);
const res2 = _call(cdr, 1, 2);
const res3 = _call(cdr, 1);

console.log("=== Transpiled Execution Results ===");
try { console.log("car = ", util.inspect(car, { depth: null, colors: true })); } catch(e) {}
try { console.log("cdr = ", util.inspect(cdr, { depth: null, colors: true })); } catch(e) {}
try { console.log("res1 = ", util.inspect(res1, { depth: null, colors: true })); } catch(e) {}
try { console.log("res2 = ", util.inspect(res2, { depth: null, colors: true })); } catch(e) {}
try { console.log("res3 = ", util.inspect(res3, { depth: null, colors: true })); } catch(e) {}
