...
const _sig_f = Object.assign(((..._args) => {
  const _sig_x = _args[0] !== undefined ? _args[0] : __unit;
  return _arithmetic('*', _sig_x, 2);
}), { expectedLength: 1, requiredLength: 1 });
const _sig_g = Object.assign(((..._args) => {
  const _sig_x = _args[0] !== undefined ? _args[0] : __unit;
  return _arithmetic('+', _sig_x, 1);
}), { expectedLength: 1, requiredLength: 1 });
const _sig_result = _call(((..._args) => _call(_sig_g, _call(_sig_f, ..._args))), 3);