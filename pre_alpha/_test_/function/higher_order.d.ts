...
export declare const map: <T extends SignValue, U extends SignValue, V extends SignValue>(g: T | Hole, x: U | Hole, ...y: V[]) => List;
export declare const result_map1: SignValue;
export declare const result_map2: SignValue;
export declare const result_sum: SignValue;
export declare const result_partial: SignValue;
export declare const test_array: List;
export declare const test_tuple: List;
