...
const map = (() => {
  ...
  return _concat((_call(_deref(g), x)), (_call(map, g, ..._expand(y))));
};
  _fn.expectedLength = 3;
  _fn.requiredLength = 2;
  _fn.hasRest = true;
  _fn.paramSpecs = [{"name":"g","defaultValue":null,"isRest":false},{"name":"x","defaultValue":null,"isRest":false},{"name":"y","defaultValue":null,"isRest":true}];
  _fn._extractIndex = -1;
  return _fn;
})();
const result_map1 = _call(map, new Address(f), 1, 2, 3, 4, 5);
const result_map2 = _call(map, new Address(((() => {
  const _fn = (x) => {
  return _arithmetic('*', x, 2);
};
  _fn.expectedLength = 1;
...
const result_sum = _call(_makePointFreeBinary((x, y) => _arithmetic('+', x, y)), 1, 2, 3, 4, 5);
const result_partial = _call(_makePointFreeMapFilter(((x) => _arithmetic('+', x, 2)), false), 1, 2, 3, 4, 5);
const test_array = _concat(_concat(_concat(_concat(1, 2), 3), 4), 5);
const test_tuple = _concat(_concat(1, a), 3);

console.log("=== Transpiled Execution Results ===");
try { console.log("f = ", util.inspect(f, { depth: null, colors: true })); } catch(e) {}
try { console.log("map = ", util.inspect(map, { depth: null, colors: true })); } catch(e) {}
try { console.log("result_map1 = ", util.inspect(result_map1, { depth: null, colors: true })); } catch(e) {}
try { console.log("result_map2 = ", util.inspect(result_map2, { depth: null, colors: true })); } catch(e) {}
try { console.log("result_sum = ", util.inspect(result_sum, { depth: null, colors: true })); } catch(e) {}
try { console.log("result_partial = ", util.inspect(result_partial, { depth: null, colors: true })); } catch(e) {}
try { console.log("test_array = ", util.inspect(test_array, { depth: null, colors: true })); } catch(e) {}
try { console.log("test_tuple = ", util.inspect(test_tuple, { depth: null, colors: true })); } catch(e) {}
