...
export declare const maybe_val: Atom;
export declare const mapped: SignValue;
export declare const g: <T extends SignValue>(x: T | Hole) => Atom;
export declare const mapped_twice: Lambda;
