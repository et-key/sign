...
const _sig_val_pow = _arithmetic('^', 2, 3);
const _sig_val_shl = {"type":"operation","operator":"<<","left":"2","right":"2","name":"bit_shift_left"};
const _sig_val_shr = {"type":"operation","operator":">>","left":"8","right":"1","name":"bit_shift_right"};
const _sig_val_or = {"type":"operation","operator":"||","left":"2","right":"1","name":"bit_or"};
const _sig_val_xor = {"type":"operation","operator":";;","left":"3","right":"1","name":"bit_xor"};
const _sig_val_and = {"type":"operation","operator":"&&","left":"3","right":"2","name":"bit_and"};
const _sig_val_not = {"type":"operation","operator":"!!","operand":"0","position":"prefix","name":"bit_not"};
const _sig_val_fact = _factorial(5);
const _sig_val_abs = _abs(-42);
const _sig_option = (() => {
  return {"type":"operation","operator":"\\n","left":{"type":"operation","operator":":","left":"<type>","right":"123","name":"define"},"right":{"type":"operation","operator":":","left":"<backend>","right":"456","name":"define"},"name":"newline"};
})();
const _sig_val_prop_1 = _get_prop(_sig_option, "type");
const _sig_val_prop_2 = {"type":"operation","operator":"@","left":"<backend>","right":"<option>","name":"get_at"};