...
export declare const js: Unit;
export declare const math: Atom;
export declare const PI_val: Atom;
export declare const PI_val_reverse: Atom;
export declare const abs_val: Atom;
