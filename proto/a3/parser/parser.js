...
const INPUT_FILE = args[0] ? path.resolve(args[0]) : path.join(__dirname, '..', 'examples', 'test.sn');
const OUTPUT_FILE = args[1] ? path.resolve(args[1]) : path.join(__dirname, '..', 'examples', 'test.json');
