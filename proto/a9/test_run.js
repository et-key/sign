...
const examplePath = path.resolve(__dirname, 'simple.sn');
const outputPath = path.resolve(__dirname, 'simple_sexpr.json');
const outputLLPath = path.resolve(__dirname, 'simple.ll');
