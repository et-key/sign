...
const fact2 = Sign_factorial(3);
const fact3 = Sign_factorial(0);
const fact4 = Sign_factorial(n);
const fact5 = Sign_factorial(x);
const fact6 = Sign_factorial((n - 1));
const fact7 = Sign_factorial((2 + 3));
const abs1 = Math.abs(x);
const abs2 = Math.abs(y);
const abs3 = Math.abs(-5);
const abs4 = Math.abs((x - y));
const abs5 = Math.abs((x + y));
const abs6 = Math.abs((10 - 50));
const unary_combo1 = (!((x < 50 ? x : NaN)));
const unary_combo2 = (!((y > 0 ? y : NaN)));
const unary_combo3 = Math.pow(-2, 3);
const unary_combo4 = (-(Math.pow(2, 3)));
const unary_combo5 = Math.abs(x) + Math.abs(y);
const unary_combo6 = Math.abs((x - 10)) * 2;
const unary_combo7 = Sign_factorial(5) + Sign_factorial(3);
const unary_combo8 = Sign_factorial(n) * 2;
const unary_complex1 = (!a || !b);
const unary_complex2 = (!((a && b)));
const unary_complex3 = (!a && !b);
const unary_complex4 = (-(Math.abs(x)));
const unary_complex5 = Math.abs((-x));
const unary_complex6 = (Sign_factorial(5) > 100 ? Sign_factorial(5) : NaN);
const unary_complex7 = (Sign_factorial(n) === 120 ? Sign_factorial(n) : NaN);
const negate = x => -x;
...
const apply3 = factorial(5);
const apply4 = logicalNot(a);