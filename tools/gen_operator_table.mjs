...
// Sign のレキサーは記号を1文字ずつ切っており、表は字句に一切関与していない。最長一致を
// 入れるとしても記号の連なりを最長で取る形になるので、そこでも表は要らない。
//
// **どこで切るかという字句の問いは #strict_infix が持っている**——preprocess が空白を
// 入れるために長いものから照合する側で、三連の等号はそちらに既に居る。意味の表と字句の
// 表が分かれているので、意味だけを外せる。
//
...
const L = [
	...
	s("どこで切るかという字句の問いは別で、それは下の 曖昧でない中置 が持っている"),
	"",
];
