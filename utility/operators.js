...
const parseTable = {
    ...
    "~/": {"precedence": 9, "notation": "infix"},
    "~^": {"precedence": 9, "notation": "infix"},
    "~": {"precedence": 10, "notation": "prefix", "associativity": "right"},
    ...
    "~": {"precedence": 20, "notation": "postfix", "associativity": "left"},
    "$": {"precedence": Infinity, "notation": "prefix", "associativity": "right"},
    "'": {"precedence": 22, "notation": "infix", "associativity": "left"},
    "@": {"precedence": 22, "notation": "infix", "associativity": "right"},
    "@": {"precedence": Infinity, "notation": "prefix", "associativity": "right"},
    "<<": {"precedence": 24, "notation": "infix", "associativity": "left"},
    ">>": {"precedence": 24, "notation": "infix", "associativity": "left"},
